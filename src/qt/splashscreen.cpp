    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("bwrgo Core");
    ...
    QString copyrightTextbwrgo   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The bwrgo Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextbwrgo);
