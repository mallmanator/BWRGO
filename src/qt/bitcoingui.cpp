    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("bwrgo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About bwrgo Core"), this);
    aboutAction->setStatusTip(tr("Show information about bwrgo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bwrgo Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the bwrgo Core help message to get a list with possible bwrgo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("bwrgo Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("bwrgo Core"); // default title
