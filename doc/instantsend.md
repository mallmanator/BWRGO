...
This mechanism has been integrated into Bitcore-Node-bwrgo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bwrgocoin/insight-api-bwrgo#web-socket-api](https://github.com/bwrgocoin/insight-api-bwrgo#web-socket-api) 
* API: [https://github.com/bwrgocoin/insight-api-bwrgo#instantsend-transactions](https://github.com/bwrgocoin/insight-api-bwrgo#instantsend-transactions) 
