...
PrivateSend uses an swamptive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
For more info see <a href=\"https://swampcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://swampcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
