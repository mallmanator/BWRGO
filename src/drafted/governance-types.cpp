...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "chipsNetwork") type = chipsNetwork;
    if(strType == "chipsNetworkVariable") type = chipsNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == chipsNetwork) s = "chipsNetwork";
    if(type == chipsNetworkVariable) s = "chipsNetworkVariable";
