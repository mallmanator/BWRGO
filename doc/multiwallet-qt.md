...
Only requiring some minor changes is bwrgo.cpp.
...
Changes to bwrgo.cpp
----------------------
bwrgo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
