    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("chips Core");
    ...
    QString copyrightTextchips   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The chips Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextchips);
